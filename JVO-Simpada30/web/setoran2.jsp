...
<%
            String JRXML_LOCAL_PATH = jvCommonClass.fnGetProperty("JRXML_LOCAL_PATH").toString();
            String REPORT_LOCAL_PATH = jvCommonClass.fnGetProperty("REPORT_LOCAL_PATH").toString();
            String OUTPUT_LOCAL_PATH = jvCommonClass.fnGetProperty("OUTPUT_LOCAL_PATH").toString();

            //String NAMA_BANK = jvCommonClass.fnGetProperty("NAMA_BANK").toString();
            //String NO_REK = jvCommonClass.fnGetProperty("NO_REK").toString();
...
<html>
    ...
    <body onload="fnGetTerbilang();fnChangePejabat();">
        <form name="main_form">
            ...
            <input type="hidden" name="hidTotal" id="hidTotal" value="<%= jvc.fnDropCurrencySign(jvc.fnFormatNumberInd(new DecimalFormat("#,###,###,###,###.##").format(intTotal))) %>">
                        ...
                        <fieldset>
                            <table border="0" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">&nbsp;:&nbsp;Rp&nbsp;<%= jvc.fnFormatNumberInd(new DecimalFormat("#,###,###,###,###.##").format(intTotal))%></td>
                                </tr>
                                <tr>
                                    <td>Dengan huruf</td>
                                    ...
                                    <td align="center" colspan="3">
                                        <table width="100%" border="0" cellpadding="1" cellspacing="1">
                                            ...
                                            <%
                                                        ...
                                                        String strNewTotal = formatter.format(dblTotal);
                                                        String strNewTotal1 = jvc.fnCutComma(strNewTotal);
                                                        String strNewTotal2 = jvc.fnFormatNumberInd(strNewTotal1);
                                                        //System.out.println("strNewTotal2: " + strNewTotal2);
                                            %>
                                            <tr class="JUDUL2">
                                                <td colspan="3">J U M L A H</td>
                                                <td align="right"><%= strNewTotal2 %></td>
                                            </tr>
