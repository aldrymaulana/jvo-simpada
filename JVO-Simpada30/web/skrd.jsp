...
<%
            ...
            String strUraianRet = "";
            String vKodeRetribusi = request.getParameter("vKode").toString();
            ...
            if (request.getSession().getAttribute("htRetribusi") != null) {
                ...
                int intHtRetribusi = htRetribusi.size();
                for (int a = 1; a <= intHtRetribusi; a++) {
                    String[] strRetribusi = (String[]) htRetribusi.get(String.valueOf(a));
                    String strKodeRetribusi = strRetribusi[0];
                    String strKetRetribusi = strRetribusi[1];
                    String strKodeNPWR = strRetribusi[2];
                    if (strKodeRetribusi.equalsIgnoreCase(vKodeRetribusi)) {
                        strUraianRet = strKetRetribusi;
                        break;
                    }
                }
            }
...
<%
            ...
            if (request.getSession().getAttribute("htNoRek") != null) {
                ...
                for (int b = 1; b <= intHtNoRek; b++) {
                    ...
                    if ((strNoRek[3].equalsIgnoreCase("RETRIBUSI")) && (strNoRek[1].equalsIgnoreCase(vKodeRetribusi))) {
                        strNoRekRetribusi = strNoRek[0];
                    }
                }
            }

            jvGeneralBusiness jvg = new jvGeneralBusiness();
            String strCountSKPD = jvg.fnGetCounter("SKRD", strNoRekRetribusi, strMonth, strYear, "0");
            //String strNoUrut = "2R." + strDate + "." + strMonth + "." + strYear + "." + jvc.fnLRPad("LPAD", strCountSKPD, "0", 5);
            String strNoUrut = strNoRekRetribusi + "." + strMonth + strYear.substring(2, 4) + "." + jvc.fnLRPad("LPAD", strCountSKPD, "0", 4);
...
<%@page import="java.text.DecimalFormat"%><html>
    ...
    <body onload="fnChangePejabat();fnGetAllElement();fnGotoLastElement();">
        <form name="main_form">
            ...
            <input type="hidden" name="hidKodePajak" id="hidKodePajak" value="<%= vKodeRetribusi%>"/>
            ...
            <input type="hidden" name="hidNoRek" id="hidNoRek" value="<%= strNoRekRetribusi%>"/>
                ...
                <tr>
                    <td colspan="3">
                        <table border="1" width="100%" cellpadding="1" cellspacing="0" topmargin="0" leftmargin="0">
                            ...
                            <%
                                        if (!strNoRekRetribusi.equalsIgnoreCase("4110606")) {
                            ...
                            <tr align="center">
                            	...
                            	<input type="text" name="hidLblNoRek_<--%= aa %>" id="hidLblNoRek_<--%= aa %>" />
                            	 -->
                                </td>
                                <td>
                            ...
                            <tr align="center">
                                ...
                                <td align="left">
                                    <table border="0" width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td align="left">
                                                <input style="text-align: left; width: 95%" value="<%= strArray[0]%>" type="text" name="txtUraian_<%= qq%>" id="txtUraian_<%= qq%>" onfocus="fnLastElement(this.name)" />
                                            </td>
                                            <td></td>
                                            <td align="right">
