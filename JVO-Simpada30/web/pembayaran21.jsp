                                                ...
                                                <table border="0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>Tgl. <input type="text" value="<%= strTglIjin%>" name="txtTglIjin_1" id="txtTglIjin_1" maxlength="10" size="10">
                                                            &nbsp;<button type="reset" disabled id="btTglIjin_1">...</button>
                                                            <script type="text/javascript">
                                                                Calendar.setup({
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>Tgl. <input type="text" value="<%= strTglIjin1%>" name="txtTglIjin_<%= a + 1%>" id="txtTglIjin_<%= a + 1%>" maxlength="10" size="10">
                                                            &nbsp;<button type="reset" disabled id="btTglIjin_<%= a + 1%>">...</button>
                                                            <script type="text/javascript">
                                                                Calendar.setup({
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3">
                                                <table border="0" cellpadding="0" cellspacing="0" topmargin="0" leftmargin="0">
                                                    ...
                                                    %>
                                                    <tr>
                                                        <td style="display: none;"><input type="radio" <%= strCheckedPajak%> name="chkPajak" id="chkPajak" value="<%= strPajak[0]%>">
                                                            &nbsp;<%= strPajak[1]%></td>
                                                        <td style="display: none;">&nbsp;</td>
                                                        <td style="display: none;"><button type="button" name="btBayar" id="btBayar" <%= strButtonPajak%> onclick="fnOpenSkpd('<%= strPajak[0]%>')">Bayar</button></td>
                                                        <td style="display: none;">&nbsp;</td>

                                                        <td><input type="radio" name="chkRetribusi" id="chkRetribusi" value="<%= strRetribusi[0]%>">
                                                            &nbsp;<%= strRetribusi[1]%></td>
                                                        <td>&nbsp;</td>
                                                        <td><button type="button" name="btBayar" id="btBayar" onclick="fnOpenSkrd('<%= strRetribusi[0]%>')">Bayar</button></td>
                                                    </tr>
                                                    <%
                                                                    }
                                                                }
