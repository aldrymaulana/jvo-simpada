...
<%@ page import="java.util.*, com.tech.master.common.*, java.text.*"%>
    ...
    <body onload="fnChangePejabat();" style="margin: 0">
        <form name="main_form">
            ...
            <table border="0" width="98%" cellpadding="1" cellspacing="1">
                ...
                <tr>
                    <td colspan="3" align="center">
                        <input type="button" <%= (strCekBtSimpan.equalsIgnoreCase("1") ? "DISABLED" : "")%> name="btSimpan" id="btSimpan" onclick="fnSimpan()" value="Simpan" />
                        <input type="button" name="btEdit" id="btEdit" onclick="fnUbah()" value="Ubah" />
                        <!--
