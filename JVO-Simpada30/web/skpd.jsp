                ...
                <tr>
                    <td colspan="3">
                        <table border="1" width="100%" cellpadding="1" cellspacing="0" topmargin="0" leftmargin="0">
                            ...
                            <%
                                        if (!strNoRekPajak.equalsIgnoreCase("4110606")) {
...
%>
                ...
                <tr>
                    <td colspan="3" align="center">
                        <button name="btSimpan" id="btSimpan" onclick="fnSimpan()">Simpan</button>
                        <!--
            		<button name="btCetak" id="btCetak" onclick="fnCetak()">Cetak</button>
            		 -->
