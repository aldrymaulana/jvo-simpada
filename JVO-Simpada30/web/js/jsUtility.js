...
{
    var NUM_DEC = 2; // jumlah angka di belakang koma
    var NUM_DEC_DEL = ","; // pemisah desimal
    var NUM_THD_DEL = ".";
    var NUM_NEF_DEL = ""; // negatif f?
    var NUM_NEB_DEL = ""; // negatif b?
    var NUM_POB_DEL = ""; // positif b?
    var NUM_POF_DEL = ""; // positif f?
