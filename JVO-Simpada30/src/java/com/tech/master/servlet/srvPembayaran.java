...
//        System.out.println(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> intSaveCounter");
                ...
                try {
                    ...
                    for (int a = 1; a <= intJmlUraianAsli; a++) {
                        ...
                        if (strJnsReklame.equalsIgnoreCase("0")) {
                            strArray[5] = String.valueOf(jvCommonClass.fnDbl2IntUP(Double.parseDouble(strSewa)));
                            strArray[6] = String.valueOf(jvCommonClass.fnDbl2IntUP(dblNilaiSewa.doubleValue()));
                        } else {
                            strArray[5] = String.valueOf(jvCommonClass.fnDbl2IntUP(dblNilaiSewa.doubleValue()));
                            Double dbUraian = Double.valueOf(Double.parseDouble(strUraian));
                            strArray[6] = String.valueOf(jvCommonClass.fnDbl2IntUP(dblNilaiSewa.doubleValue() * dbUraian.doubleValue()));
                        }
                        htUraian.put(String.valueOf(a), strArray);
                    }
