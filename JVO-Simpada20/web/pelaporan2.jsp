	...
	if (request.getSession().getAttribute("htGetBukuKasUmum") != null) {
		...
		for (int a=1; a<=intHtRincian; a++) {
			...
			<tr class="<%= strNmClass %>">
				...
				<td align="right">&nbsp;<%= (strArray[3].equals("0.0"))?"":new java.text.DecimalFormat("#,###,###,###,###.##").format(Double.parseDouble(strArray[3])) %></td>
				<td align="right">&nbsp;<%= (strArray[4].equals("0.0"))?"":new java.text.DecimalFormat("#,###,###,###,###.##").format(Double.parseDouble(strArray[4])) %></td>
			</tr>
