...
<%@page import="java.text.DecimalFormat"%><html>
    ...
    <body onload="fnChangePejabat();fnGetAllElement();fnSetSlctSatuan();fnGotoLastElement();">
    <form name="main_form">
                ...
                <td colspan="2">
                    <table>
                        ...
                        <tr valign="top">
                            ...
                            <td>&nbsp;:&nbsp;</td>
                            <td><input type="text" name="jnsPekerjaan" id="jnsPekerjaan" value="<%= strJnsPekerjaan %>"></input></td>
                        </tr>
                    </table>
                </td>
                <td>&nbsp;</td>
			                            ...
			                            <td>
			                            	<select name="slctKdWilayah_<%= aa %>" id="slctKdWilayah_<%= aa %>" 
			                            	 ...
			                            	 <input type="text" style="width: 30px" 
			                            	 		...
			                            	 		value="<%= strUraian %>" 
			                            	 		onblur="fnHitungReklame('<%= aa %>')"></input>
				                            		...
				                            		<tr>
				                            			<td align="left">
				                            				<input style="text-align: left; width: 95%" value="<%= strArray[0] %>" 
				                            					...
				                            					onfocus="fnLastElement(this.name)"></input>
				                            			</td>
				                            			<td></td>
				                            			<td align="right">
