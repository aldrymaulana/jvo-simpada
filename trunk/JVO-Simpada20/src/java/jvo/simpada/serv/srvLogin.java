        ...
        throws ServletException, IOException
    {
        ...
        case 0: // '\0'
            try
            {
                ...
                out.println("var lVarWidth = 1024;");
                out.println("var lVarHeight = 768;");
                out.println("var vXPos = (screen.availWidth - lVarWidth) / 2;");
                out.println("var vYPos = (screen.availHeight - lVarHeight) / 2;");
                out.println("var winprops = 'width='+lVarWidth+',height='+lVarHeight+',top='+vYPos+',left='+vXPos+',status=yes,resizable=yes,toolbar=no,menubar=no,scrollbars=yes,location=no,titlebar=no,hotkeys=no';");
