        ...
        switch (Integer.parseInt(strMode)) {
            case 0:
                try {
                    ...
                    jvCommonClass.fnWriteLog("srvPendaftaran, case 0", (new StringBuilder("Exception: ")).append(exp).toString());
                }
                return;
            ...
            case 1:
                try {
                    ...
                    jvCommonClass.fnWriteLog("srvPendaftaran, case 1", (new StringBuilder("Exception: ")).append(exp).toString());
                }
                return;
            ...
            case 2:
                try {
                    ...
                    jvCommonClass.fnWriteLog("srvPendaftaran, case 2", (new StringBuilder("Exception: ")).append(exp).toString());
                }
                return;
            ...
            case 3:
                try {
                    ...
                    jvCommonClass.fnWriteLog("srvPendaftaran, case 3", (new StringBuilder("Exception: ")).append(exp).toString());
                }
                return;
            ...
            case 4:
                ...
                try {
                    ...
                    jvCommonClass.fnWriteLog("srvPendaftaran, case 4", (new StringBuilder("Exception: ")).append(exp).toString());
                }
                return;
            ...
            case 5:
                try {
                    ...
                    jvCommonClass.fnWriteLog("srvPendaftaran, case 5", (new StringBuilder("Exception: ")).append(exp).toString());
                }
                return;
            ...
            case 6:
                try {
                    ...
                    jvCommonClass.fnWriteLog("srvPendaftaran, case 6", (new StringBuilder("Exception: ")).append(exp).toString());
                }
                return;
        }
    }
