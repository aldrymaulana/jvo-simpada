...
public class srvPembayaran2 extends HttpServlet
{

    public srvPembayaran2()
    {
        ...
        throws ServletException, IOException
    {
        ...
        String strIfFrame = "ifPembayaran2";
        ...
        case 3: // '\003'
            try
            {
                ...
                if(strKdCetak.equalsIgnoreCase("L"))
                    strKodeSimpan = "1";
                String strCountSKPD = jvg.fnGetCounter("PAD", strNoRek, strMonth, strYear, strKodeSimpan);
        ...
        case 4: // '\004'
            try
            {
                ...
                response.sendRedirect((new StringBuilder("pad.jsp?vWidth=")).append(strWidth).append("&vHeight=").append(strHeight).append("&vKode=").append(strKodePajak).toString());
                return;
            }
            catch(Exception exp)
            {
        ...
        throws ServletException, IOException
    {
        try
        {
            ...
            parameters.put("pTitle1", "SURAT KETETAPAN DENDA PAJAK DAERAH");
            parameters.put("pTitle2", "(SKDP-DAERAH)");
            String strNamaBendahara = "";
            String strNIPBendahara = "";
            Hashtable htInfoPejabat1 = jvg.fnGetInfoPejabat();
            int intHtInfoPejabat = htInfoPejabat1.size();
            ...
            String strFilePDF = (new StringBuilder("PAD_")).append(strNoNPWPD.replace('.', '_')).append("_").append(strToday).append(".pdf").toString();
