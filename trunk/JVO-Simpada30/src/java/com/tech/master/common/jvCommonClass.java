...
public class jvCommonClass {

    public jvCommonClass() {
    }
...
//            System.out.println("strNumber2: " + strNumber2);
    ...
    public static void fnWriteLog(String lStrClassName, String lStrMess) {
        ...
        try {
            jvCommonClass lObjLog;
            lObjLog = new jvCommonClass();
    ...
    protected static void fnSetProperties(jvCommonClass lObjLog) {
