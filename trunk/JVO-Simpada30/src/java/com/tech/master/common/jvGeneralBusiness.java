 ...
 * @author Sharkie
 */
public class jvGeneralBusiness {

    private String DBurl = "jdbc:odbc:" + jvCommonClass.fnGetProperty("DSN");
    private Connection con;
    private Statement stmt;
    private ResultSet rs;
    private ResultSetMetaData rsmd;
    private jvCommonClass jvc = new jvCommonClass();
   
    public jvGeneralBusiness() {
