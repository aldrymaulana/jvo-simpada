...
<html>
        ...
        <script type="text/javascript">
            ...
            */
            ...
            function fnTestPage() {
                document.main_form.method = "post";
                document.main_form.mode.value = 0;
                document.main_form.action = "srvTestPage";
    ...
    <body topmargin="0" leftmargin="0">
        ...
        <table width="<%= intWidth %>" height="<%= intHeight*0.95 %>" border="1" cellpadding="0" cellspacing="0">
            <tr valign="middle">
                <td align="center">
                    <table width="<%= intWidth %>" height="<%= intHeight*0.95 %>" border="0" cellpadding="0" cellspacing="0">
                        <tr valign="top">
                            <td>
