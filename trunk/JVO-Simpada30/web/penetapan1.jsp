    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function fnOpenSkpd(vKode) {
                ...
                window.location = 'skpd1.jsp?vWidth='+lVarWidth+'&vHeight='+lVarHeight+'&vKode='+vKode;
            }
            ...
            function fnOpenSkrd(vKode) {
                ...
                window.location = 'skrd.jsp?vWidth='+lVarWidth+'&vHeight='+lVarHeight+'&vKode='+vKode;
            }
            ...
            function fnOpenPAD(vKode) {
                ...
                window.location='pad.jsp?vWidth='+lVarWidth+'&vHeight='+lVarHeight+'&vKode='+vKode;
            }
        </script>
    </head>
