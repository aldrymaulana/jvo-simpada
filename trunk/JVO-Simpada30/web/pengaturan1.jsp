...
<form name="main_form">
    ...
    <input type="hidden" name="uKeyPemda" id="uKeyPemda"/>
	<input type="hidden" name="idxKary" id="idxKary"/>
	<input type="hidden" name="txtJabatanKary" id="txtJabatanKary"/>
	<input type="hidden" name="idxLogin" id="idxLogin"/>
	<input type="hidden" name="idxAkses" id="idxAkses"/>
<a name="top"></a>
<fieldset>
	<legend>
				...
				<table border="0" cellpadding="2" cellspacing="2">
					...
					<tr align="left">
						<td>
                                                    ...
                                                    <li><a href="#pemda">Informasi Pemerintah Daerah</a>
                                                    <li><a href="#karyawan">Informasi Karyawan</a>
                                                    <li><a href="#login">Informasi Login</a>
                                                    <li><a href="#akses">Informasi Hak Akses</a>
                                                    <li><a href="#bank">Informasi Bank</a>
                                                        <br>
...
<fieldset>
	...
	<table border="0" cellpadding="2" cellspacing="2">
		<tr align="left">
			...
			<td><input style="width: 80%" type="text" name="txtNamaPemda" id="txtNamaPemda" value="<%= strNamaPemda %>"/></td>
		</tr>
		<tr align="left">
...
<fieldset>
	...
	<table border="0" cellpadding="2" cellspacing="2">
		...
		<tr class="TANYA">
			...
			<td><input type="text" name="txtNamaKary" id="txtNamaKary"/></td>
			<td>
			...
			<td><input type="text" name="txtNipKary" id="txtNipKary"/></td>
			<td><input type="text" name="txtAlamatKary" id="txtAlamatKary"/></td>
		</tr>
		<tr class="JUDUL2" align="center">
			<td>No</td>
			<td>RT</td>
		...
		<tr class="TANYA">
			<td><input type="text" name="txtNoKary" id="txtNoKary"/></td>
			<td><input type="text" name="txtRTKary" id="txtRTKary"/></td>
			<td><input type="text" name="txtRWKary" id="txtRWKary"/></td>
			<td><input type="text" name="txtRKKary" id="txtRKKary"/></td>
		</tr>
		<tr class="JUDUL2" align="center">
			<td>Kelurahan</td>
			<td>Kecamatan</td>
		...
		<tr class="TANYA">
			<td><input type="text" name="txtKelurahanKary" id="txtKelurahanKary"/></td>
			<td><input type="text" name="txtKecamatanKary" id="txtKecamatanKary"/></td>
			<td><input type="text" name="txtKotamadyaKary" id="txtKotamadyaKary"/></td>
			<td><input type="text" name="txtKodePosKary" id="txtKodePosKary"/></td>
		</tr>
		<tr class="JUDUL2" align="center">
			<td>Telepon</td>
			<td>Facsimie</td>
		...
		<tr class="TANYA">
			<td><input type="text" name="txtTeleponKary" id="txtTeleponKary"/></td>
			<td><input type="text" name="txtFacsimileKary" id="txtFacsimileKary"/></td>
			<td></td>
			<td></td>
		</tr>
		...
		<tr class="<%= strNmClass %>">
			<td align="right" rowspan="7">
				<input type="hidden" name="txtUkeyKary_<%= b %>" id="txtUkeyKary_<%= b %>" value="<%= strUkey %>"/>
			...
			<td><input type="text" name="txtNamaKary_<%= b %>" id="txtNamaKary_<%= b %>" value="<%= strNama %>"/></td>
			<td>
			...
			<td><input type="text" name="txtNipKary_<%= b %>" id="txtNipKary_<%= b %>" value="<%= strNip %>"/></td>
			<td><input type="text" name="txtAlamatKary_<%= b %>" id="txtAlamatKary_<%= b %>" value="<%= strAlamat %>"/></td>
		</tr>
		<tr class="JUDUL2" align="center">
			<td>No</td>
			<td>RT</td>
		...
		<tr class="<%= strNmClass %>">
			<td><input type="text" name="txtNoKary_<%= b %>" id="txtNoKary_<%= b %>" value="<%= strNo %>"/></td>
			<td><input type="text" name="txtRTKary_<%= b %>" id="txtRTKary_<%= b %>" value="<%= strRT %>"/></td>
			<td><input type="text" name="txtRWKary_<%= b %>" id="txtRWKary_<%= b %>" value="<%= strRW %>"/></td>
			<td><input type="text" name="txtRKKary_<%= b %>" id="txtRKKary_<%= b %>" value="<%= strRK %>"/></td>
		</tr>
		<tr class="JUDUL2" align="center">
			<td>Kelurahan</td>
			<td>Kecamatan</td>
		...
		<tr class="<%= strNmClass %>">
			<td><input type="text" name="txtKelurahanKary_<%= b %>" id="txtKelurahanKary_<%= b %>" value="<%= strKelurahan %>"/></td>
			<td><input type="text" name="txtKecamatanKary_<%= b %>" id="txtKecamatanKary_<%= b %>" value="<%= strKecamatan %>"/></td>
			<td><input type="text" name="txtKotamadyaKary_<%= b %>" id="txtKotamadyaKary_<%= b %>" value="<%= strKotamadya %>"/></td>
			<td><input type="text" name="txtKodePosKary_<%= b %>" id="txtKodePosKary_<%= b %>" value="<%= strKodePos %>"/></td>
		</tr>
		<tr class="JUDUL2" align="center">
			<td>Telepon</td>
			<td>Facsimie</td>
		...
		<tr class="<%= strNmClass %>">
			<td><input type="text" name="txtTeleponKary_<%= b %>" id="txtTeleponKary_<%= b %>" value="<%= strTelepon %>"/></td>
			<td><input type="text" name="txtFacsimileKary_<%= b %>" id="txtFacsimileKary_<%= b %>" value="<%= strFacsimile %>"/></td>
			<td></td>
			<td></td>
		</tr>
		<%
...
<fieldset>
	...
	<table border="0" cellpadding="2" cellspacing="2">
		...
		%>
				<tr class="<%= strNmClass %>">
					<td align="center">
						<input type="hidden" name="txtUkey_<%= c %>" id="txtUkey_<%= c %>" value="<%= strUkeyL %>"/>
					...
					<td><%= strNamaL %></td>
					<td><input type="text" name="txtLogin_<%= c %>" id="txtLogin_<%= c %>" value="<%= strLoginL %>"/></td>
					<td><input type="text" name="txtPassword_<%= c %>" id="txtPassword_<%= c %>" value="<%= strPasswordL %>"/></td>
				</tr>
		<%
		rowNum = rowNum + 1;
			}
...
<fieldset>
	...
	<table border="0" cellpadding="2" cellspacing="2">
		...
		%>
				<tr class="<%= strNmClass %>">
					<td align="center">
						<input type="hidden" name="txtMenuKey_<%= c %>" id="txtMenuKey_<%= c %>" value="<%= c %>"/>
						<input type="hidden" name="txtKdJabatan_<%= c %>" id="txtKdJabatan_<%= c %>" value="<%= strKodeJabatan %>"/>
					...
					<td><%= strJabatan %></td>
					<td align="center"><input type="checkbox" <%= (str10000.trim().equals("1"))?"CHECKED":"" %> name="chk10000_<%= c %>" id="chk10000_<%= c %>"/></td>
					<td align="center"><input type="checkbox" <%= (str20000.trim().equals("1"))?"CHECKED":"" %> name="chk20000_<%= c %>" id="chk20000_<%= c %>"/></td>
					<td align="center"><input type="checkbox" <%= (str30000.trim().equals("1"))?"CHECKED":"" %> name="chk30000_<%= c %>" id="chk30000_<%= c %>"/></td>
					<td align="center"><input type="checkbox" <%= (str40000.trim().equals("1"))?"CHECKED":"" %> name="chk40000_<%= c %>" id="chk40000_<%= c %>"/></td>
					<td align="center"><input type="checkbox" <%= (str50000.trim().equals("1"))?"CHECKED":"" %> name="chk50000_<%= c %>" id="chk50000_<%= c %>"/></td>
					<td align="center"><input type="checkbox" <%= (str60000.trim().equals("1"))?"CHECKED":"" %> name="chk60000_<%= c %>" id="chk60000_<%= c %>"/></td>
				</tr>
		<%
		rowNum = rowNum + 1;
			}
...
<fieldset>
	...
	<table border="0" cellpadding="2" cellspacing="2">
		...
		%>
				<tr class="<%= strNmClass %>">
					<td align="center">
						<input type="hidden" name="txtKodeB_<%= c %>" id="txtKodeB_<%= c %>" value="<%= strKodeB %>"/>
						<button type="button" onclick="fnSimpanBank(<%= c %>)" name="btSimpan" id="btSimpan">Simpan</button>
						<button type="button" onclick="fnBatal()" name="btBatal" id="btBatal">Batal</button>
					</td>
					<td width="30" align="center"><%= c %></td>
					<td><input type="text" name="txtNamaB_<%= c %>" id="txtNamaB_<%= c %>" value="<%= strNamaB %>"/></td>
					<td><input type="text" name="txtNoRekB_<%= c %>" id="txtNoRekB_<%= c %>" value="<%= strNoRekB %>"/></td>
					<td><%= strKodeB %></td>
				</tr>
		<%
		rowNum = rowNum + 1;
